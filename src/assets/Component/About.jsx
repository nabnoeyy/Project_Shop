      ...
      <div className="about-content">
        ...
        <div className="about-text">
          ...
          <p>
            ...
            ในราคาเพียง <strong>20 บาท</strong> ที่จับต้องได้และรสชาติที่เป็นเอกลักษณ์
            ทำให้ลูกค้าทุกเพศทุกวัยติดใจ
          </p>
          <p>
            Hop Chafe เป็นส่วนหนึ่งของทุกวัน ดื่มด่ำทุกช่วงเวลา
            <strong> "HOP UP YOU DAY" </strong>
          </p>
        </div>
